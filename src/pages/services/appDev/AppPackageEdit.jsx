...
const AppPackageEdit = ({ data, handleDialogClose }) => {
    ...
    const mutation = useMutation({
        mutationFn: (input) => axiosReq.put(`/apppackage/update/${data._id}`, input, { headers: { Authorization: token } }),
        onSuccess: (res) => {
    ...
    return (
        <Box>
            <Typography variant='h5' color='gray' mb={3}>Edit App Package</Typography>
            <Box sx={{
                display: 'flex',
